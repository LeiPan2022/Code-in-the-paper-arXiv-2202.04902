function [Entropy_Magnons_PXP2]=PXP_Magnons_Entropy2(L,Pi_Magnons_vec2)
...
num_site=L/2; 
Entropy_Magnons_PXP2=zeros(L/2+1,1);
 
for kk=1:L/2+1
    
    kk
    rho0=zeros(Dim_sub2,Dim_sub2); 
  state=Pi_Magnons_vec2(:,kk);
...
Entropy_Magnons_PXP2(kk,1)=-trace(Rho_temp*logm(Rho_temp+0.000000000001));
warning('off')
end
